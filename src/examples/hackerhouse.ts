...
import { mulberry32, patchMathLib, xmur3 } from './hackerhouse/lib/math';
import levelSystem from './hackerhouse/systems/levelSystem';
import physicsSystem from './hackerhouse/systems/physicsSystem';
import shipSystem from './hackerhouse/systems/shipSystem';
...
export class HackerHouse implements GameModule {
    ...
    run = (playerData: PlayerData[], deltaTime: number, t: number): void => {
        // patch math lib
        const seed = xmur3(t.toString() + 'hackerHouse');
