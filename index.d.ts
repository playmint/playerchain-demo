...
declare module "socket:async/context" {
    ...
    export class Variable<T> {
         ...
         */
        run<T_1, F extends (...args: any) => any>(value: T_1, fn: F, ...args: Parameters<F>[]): ReturnType<F>;
        /**
    ...
    export class Snapshot {
         ...
         * @returns {ReturnType<F>}
         */
        run<F extends (...args: any) => any>(fn: F, ...args: Parameters<F>[]): ReturnType<F>;
        #private;
    }
    /**
...
declare module "socket:internal/conduit" {
     ...
     */
    export const pool: Set<WeakRef<Conduit>>;
    /**
...
declare module "socket:latica/packets" {
     ...
     */
    export const sha256: (arg0: string | Buffer | Uint8Array, opts?:any) => Promise<string>;
